...
from com.taxicoop.dto.NewUser import RegisterNewUserDTO
from com.taxicoop.service.DBHelper import DB_Helper
from com.taxicoop.service.user_service import User_Service
...
mandatory_new_user_request_fields = {'user_id', 'longitude', 'latitude', 'email', "name", 'contact_number'}
